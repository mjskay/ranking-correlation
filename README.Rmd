...
```{r looking_at_data_for_censoring_above, fig.width=8, fig.height=10}
df %>%
...
```{r looking_at_data_for_censoring_below, fig.width=8, fig.height=10}
df %>%
...
```{r censored_versus_not_comparison_3, fig.width=9, fig.height=10}
ggplot(
        df,
        aes(x=r, y=log2(jnd)),
    ) + 
...
```{r plot_mu_by_r, fig.width=8.5, fig.height=6.5}
mu_by_r %>%
    ggplot(
